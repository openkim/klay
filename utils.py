"""
Functions from this file is absorbed from the OCP github repo 
(https://github.com/FAIR-Chem/fairchem/tree/main/src/fairchem/core).

COPYRIGHT WARNING: The code is not ours.
"""
